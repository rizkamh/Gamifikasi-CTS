...
function klikstart() {
	...
	if (tp == "Essai") {
		...
		for (let i = 0; i < textarea.length; i++) {
			...
			$("#tanya" + i).val(tanya[i]);
			var confidenceHTML = "<div class='confidence' style='margin-top:10px;'>" +
			"<label><input type='radio' name='confident" + i + "' value='Yakin'> Yakin</label>" +
			"<label><input type='radio' name='confident" + i + "' value='Tidak Yakin'> Tidak Yakin</label>" +
			"</div>";
			$('#form2').append(confidenceHTML);
		}
		...
		success: function (data) {
			...
			for (var i = 0; i < data.length; i++) {
                html += "<li id='pertanyaan" + i + "'>" + data[i].isiesai + "</li>" +
                    "<textarea class='span12' rows='4' name='jawaban" + i + "' id='jawaban" + i + "' placeholder='Ketikan jawaban...' data-id='" + data[i].idsoal + "'></textarea>" +
                    "<div class='confidence' style='margin-top:10px;'>" +
                    "<label><input type='radio' name='confident" + i + "' value='Yakin'> Yakin</label>" +
                    "<label><input type='radio' name='confident" + i + "' value='Tidak Yakin'> Tidak Yakin</label>" +
                    "</div><br>";
