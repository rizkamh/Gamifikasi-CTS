...
public function upload(Request $request) {
    $file = $request->file('upload'); // 'upload' is the default field name CKEditor uses
    $path = $file->store('public/uploads'); // Stores file in storage/app/public/uploads

    $url = Storage::url($path); // Gets the URL of the file
