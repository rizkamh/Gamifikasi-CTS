...
<script src="assets/ckfinder/ckfinders.js"></script>
<script>
	// Replace the <textarea id="editor1"> with a CKEditor
	// instance, using default configuration.
	CKEDITOR.replace('isiesai', {
		filebrowserBrowseUrl: 'assets/ckfinders/ckfinder.html',
		filebrowserUploadUrl: 'assets/ckfinders/core/connector/php/connector.php?command=QuickUpload&type=Files',
	...
	CKFinder.setupCKEditor('isiesai');
	CKFinder.setupCKEditor('jawaban');
</script>
<!-- <script>
	var seq = 0;
