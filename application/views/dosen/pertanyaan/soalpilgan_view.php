			...
			<div class="widget-box">
				...
				<div class="widget-content nopadding">
					<form action="" id="form1" name="form1" class="form-horizontal" enctype="multipart/form-data">
						...
						<input type="hidden" name="tipetugas" value="tugas">
							<label class="control-label" for="leveltugas"><strong>Level Pertanyan</strong></label>
							<div class="controls">
								<select id="leveltugas" name="leveltugas" class="form-control">
									<option disabled selected>Pilih</option>
									<?php foreach ($level as $key => $value) { ?>
										<option value="<?php echo $value['idlevel'] ?>"><?php echo $value['nama_level'] ?></option>
									<?php } ?>
								</select>
								<span name="leveltugas"></span>
							</div>
						</div>	
						<div class="control-group">
						...
						<div class="control-group">
							<label class="control-label"><strong>No	Soal</strong></label>
							<div class="controls">
								<input class="span1" type="text" id="nopilgan" name="nopilgan" readonly>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label"><strong>Point	Soal</strong></label>
							<div class="controls">
								<input class="span1" type="number" id="pointsoal" name="pointsoal">
							</div>
						</div>
						<div class="control-group">
