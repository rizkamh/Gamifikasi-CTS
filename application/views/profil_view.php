...
<div id="content">
	<div id="content-header">
		<div id="breadcrumb"> <a href="home" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="profil" class="current">Profil</a> </div>
		<h1><span class="icon-briefcase"></span>
			Profil <small>Computational Thinking</small></h1>
	</div>
	<hr>
	<div class="container">
					...
					<div class="modal-body">
						<form class="form-horizontal" id="form2">
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" id="passwordlama" placeholder="Password Lama" autocomplete="new-password">
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="passwordbaru1">Password Baru</label>
								<div class="controls">
									<input type="password" id="passwordbaru1" placeholder="Password Baru" autocomplete="new-password">
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="passwordbaru2">Password</label>
								<div class="controls">
									<input type="password" id="passwordbaru2" placeholder="Ulang Password" autocomplete="new-password">
								</div>
							</div>
							<div class="control-group">
								<div class="controls">
		...
		<div class="container-fluid">
			<div class="row-fluid">
				<div class="span5 offset1">
					...
					<form enctype="multipart/form-data" method="post" action="<?php echo site_url('profil/simpan'); ?>">
						<table style="font-size:20px; font-family:serif;">
							<tr>
								<td style="width:130px;"><label for="idadmin"></label>User ID</td>
								<td></td>
								<td><input type="text" readonly id="idadmin" name="idadmin" value="<?= $profil->idadmin ?>"></td>
							</tr>
							<tr>
								<td style="width:130px;"><label for="namaadmin"></label>Nama</td>
								<td></td>
								<td><input type="text" id="namaadmin" name="namaadmin" value="<?= $profil->namaadmin ?>"></td>
							</tr>
							<tr>
								<td style="width:130px;"><label for="alamat"></label>Alamat</td>
								<td></td>
								<td>
									<textarea name="alamat" id="alamat" cols="40" rows="3"><?= $profil->alamat ?></textarea>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td></td>
								<td><input type="date" id="tanggallahir" name="tanggallahir" value="<?= $profil->tanggallahir ?>"></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<select id="jekel" name="jekel" class="form-control">
										<option value="<?= $profil->jekel ?>" selected disabled hidden>
											<?= $profil->jekel ?></option>
										<option value="L" <?php if ($profil->jekel == 'L') {
																echo 'selected';
															} ?>>Laki-Laki</option>
										<option value="P" <?php if ($profil->jekel == 'P') {
																echo 'selected';
															} ?>>Perempuan</option>
									</select>
								</td>
						...
						<div class="span2">
							<img style="margin-top:12px;" id="tampil" src="<?= base_url("assets/img/fotomahasiswa/" . $this->session->userdata("ses_id") . ".jpeg") ?>" alt="your image" />
						...
						<div class="span12 offset2">
							...
							<button type="submit" class="btn btn-warning" id="simpan" style="margin-top:20px; "><span class="icon-floppy-disk"></span> Simpan</button>
						</div>
					</form>
				</div>
			</div>
