		...
		<div class="container-fluid">
			<div class="row-fluid">
				<div class="span12 offset1">
					...
					<form enctype="multipart/form-data" method="post" action="<?php echo site_url('hmahasiswa/profil/simpan'); ?>">
						<div class="span5">
								...
								<tr>
									...
									<td>
										<select id="jekel" name="jekel" class="form-control">
											...
											<option <?php if($profil->jekel == 'L') { echo "selected"; } ?> value="L">Laki-Laki</option>
											<option <?php if($profil->jekel == 'P') { echo "selected"; } ?> value="P">Perempuan</option>
										</select>
									</td>
								</tr>
								<tr>
						...
						<img style="margin-top:12px;" id="tampil"
							src="<?= base_url("assets/img/fotomahasiswa/".$this->session->userdata("ses_id").".jpeg")?>"
							alt="your image" />
