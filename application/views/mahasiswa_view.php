...
<li class="submenu open"> <a href="#"><i class="icon icon-th-list"></i> <span>Manage Mahasiswa</span> <span class="icon icon-chevron-down pull-right" style="margin-right: 5px;"></span></a>
	<ul>
...
<div id="content">
	<div id="content-header">
		<div id="breadcrumb"> <a href="home" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="mahasiswa" class="current">Mahasiswa</a> </div>
					...
					<div class="modal-body">
						<form class="form-horizontal" action="">
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" id="nim" name="nim" minlength="10" maxlength="10" class="form-control">
								</div>
							</div>
							<div class="control-group">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form name="form2" id="form2" enctype="multipart/form-data">
							...
							<h3> Apakah Data Mahasiswa yang anda masukkan sudah BENAR ? </h3>
			...
			<div class="span12">
				...
				<div class="widget-box">
					...
					<div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
						<h5>Data Mahasiswa Computational Thinking</h5>
					</div>
